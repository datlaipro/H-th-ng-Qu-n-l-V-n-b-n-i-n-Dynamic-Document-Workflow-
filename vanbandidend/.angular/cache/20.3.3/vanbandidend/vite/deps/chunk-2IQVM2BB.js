...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g = m2[u], f2 = ve(g), p2 = z(u, a2) ? Q(d) : Q(d, ee(u));
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  let a2 = function(l, o = {}, c = []) {
    ...
    if (typeof this.value == "string" && k.test(this.value)) {
      let u = this.value.trim().replace(k, (g) => {
        var y;
        let f2 = g.slice(1, -1), x = this.tokens[f2];
    ...
    Object.entries(l).forEach(([m2, d]) => {
      ...
      i(d) ? n(d, u, g) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x = {}, p2 = []) => {
  ...
  return r === "class" || r === "attr" ? C(s2(t) ? `${e}${t},${e} ${t}` : e, s4) : C(e, C(t != null ? t : ":root,:host", s4));
...
//# sourceMappingURL=chunk-2IQVM2BB.js.map
