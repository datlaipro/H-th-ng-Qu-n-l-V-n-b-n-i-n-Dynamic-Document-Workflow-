...
public interface AuthService {
    ...
    void login(LoginRequest req, HttpServletRequest httpReq, HttpServletResponse httpResp) ;

    /** Chỉ ADMIN mới được tạo EMPLOYEE */
    long registerEmployee(RegisterRequest req) ;
    ...
    void refresh(HttpServletRequest httpReq, HttpServletResponse httpResp) ;

    /** Lấy user hiện tại từ cookie SESSION (đã verify ở Filter) */
    User me(HttpServletRequest httpReq) ;
}
